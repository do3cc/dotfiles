...
plugins=(git knife pip python sublime supervisor vagrant fabric rvm virtualenvwrapper tmuxinator)
...
(which monkeysphere && ! ssh-add -L > /dev/null && eval `monkeysphere s`)
